        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">Modification clients / revendeurs</h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('client.update', $client) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="c_type" name="c_type" required>
                                <option value="SIMPLE"
                                    {{ old('c_type', $client->c_type) == 'SIMPLE' ? 'selected' : '' }}>Simple
                                </option>
                                <option value="REVENDEUR"
                                    {{ old('c_type', $client->c_type) == 'REVENDEUR' ? 'selected' : '' }}>
                                    Revendeur
                                </option>
                            </select>
                        </div>
