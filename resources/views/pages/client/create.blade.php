<div class="row">
    ...
    <div class="col-lg-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('c_tel') is-invalid @enderror" id="c_tel"
                name="c_tel" value="{{ old('c_tel') }}" minlength="10" maxlength="25">
            @error('c_tel')
    ...
    <div class="col-lg-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('c_adr') is-invalid @enderror" id="c_adr"
                name="c_adr" value="{{ old('c_adr') }}">
            @error('c_adr')
                <span class="invalid-feedback" role="alert">
                    Adresse invalide
                </span>
